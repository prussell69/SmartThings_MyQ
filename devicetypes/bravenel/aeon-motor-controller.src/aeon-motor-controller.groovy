...
//		fingerprint inClusters: "0x26,0x32"
	...
	tiles {
		standardTile("motor", "device.motor", width: 2, height: 2) {
			state("stopUp", label:'StopCls', icon:"st.doors.garage.garage-closed", action: 'down', backgroundColor:"#79b821")
			state("stopDn", label:'StopOpn', icon:"st.doors.garage.garage-open", action: 'up', backgroundColor:"#79b821")
			state("up", label:'Close', icon:"st.doors.garage.garage-closing", action:'stop', backgroundColor:"#ffe71e")
			state("down", label:'Open', icon:"st.doors.garage.garage-opening", action:'stop', backgroundColor:"#ffe71e")
		}
        ...
        standardTile("up", "device.switch") {
        	state "default", label: "Cls", action: "up", icon:"http://cdn.device-icons.smartthings.com/thermostat/thermostat-down@2x.png"
        }
        standardTile("down", "device.switch") {
        	state "default", label: "Opn", action: "down", icon:"http://cdn.device-icons.smartthings.com/thermostat/thermostat-up@2x.png"
        }
	}
	main(["motor"])
